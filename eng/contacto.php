...
<img id="icono" src="../assets/images/iconotxt.png" alt="">
	<form id="form" class="blocks" action="enviar.php" method="post">
	    ...
	    <p><br>
	        <label>Adults &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Childrens</label><br>
	   ...
	   <br><br> <b><input type="submit" class="submit" value="Send" /></b> 
...
<div id="ubicacion">
    <span>
        <b>Location</b><br><br>
        <p>The B&B is situated 4 blocks from the center of Puerto Varas and is close to the principal convention  centers, also only 3 blocks from Llanquihue Lake.  You can count on private parking, Wifi, and a bilingual receptionist.</p><br /><br />
        <p>Adress: Decher 440, Puerto Varas, <br>Regi&oacute;n de los Lagos, Chile.</p>
        <br /><br />
        <p>Phone-Fax: +56 65 233921 </p>  
    </span>

<br/>
<br/>
<br/>
<input id="boton" type="button" value="See in Google Maps" onclick="window.open('http://maps.google.cl/maps?f=q&source=s_q&hl=es&geocode=&q=decher+440,+puerto+varas,+region+de+los+lagos,+chile&aq=&sll=-33.40849,-70.569332&sspn=0.004997,0.009645&vpsrc=0&ie=UTF8&hq=&hnear=Decker+440,+Puerto+Varas,+Llanquihue,+Los+Lagos&t=m&z=16&ei=_m0hT7eeBIjozAS11Z2QCg&pw=2')">
</div>
