...
<<script type="text/javascript">
    ...
    <?php  
                if($_GET[status] == "ok")
                {
                    echo '  <div id="test">
    <span>
        <b>Gracias Por Contactarnos</b><br><br>
        <p>Hemos recibido tu mensaje correctamente, y nos comunicaremos contigo a la brevedad.</p>
        <p>Recuerda que en caso de cualquier duda o consulta, nos puedes contactar por cualquiera de los medios que tenemos a tu disposicion.
        <br>
        <br>
        <br>
        <br>
        <p><b>Direcci&oacute;n:</b><b> Decher 440, Puerto Varas, Regi&oacute;n de los Lagos, Chile.</b></p>
        <p><b>Fono-Fax:</b> <b>+56 65 233921</b> </p>  
        <br>
        <br>
        <br>
        <br>
        <input type="button" name="volver" value="Volver al Home" style="width:200px;" onclick=document.location.href=pagina;>
    </span>
                ...
                else if($_GET[status] == "error")
                {
                    echo '  <div class"BoxGraciasContacto" id="test">
                                ...
                                <b>Error</b><br><br>
                                    No fue posible procesar su env&iacute;o, por favor int&eacute;ntelo nuevamente.<br><br>
                                    It was no possible to receive your request.
                                    <br><br>
                                    <!--<a id="home" href="javascript:window.history.go(-1)"><b>
                                    Volver al Formulario de Contacto / Back to the contact form.</b></a>-->

                                    
                                    <br/><br/>
                                    <b><input type="button" name="volver" value="Corregir Formulario" style="width:200px;" onclick="window.history.go(-1)"></b>
                                </span> </div></div>
